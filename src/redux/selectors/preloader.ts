...
export const authPreloader = createSelector(
  selectAuthState, 
  (state) => state.preloader);

export const canvasPreloader = createSelector(
  selectCanvasState, 
  (state) => state.preloader);

export const imagesPreloader = createSelector(
  selectImagesState, 
  (state) => state.preloader);

export const timelinePreloader = createSelector(
  selectTimelineState, 
  (state) => state.preloader);

export const profilePreloader = createSelector(
  selectProfileState, 
  (state) => state.preloader);